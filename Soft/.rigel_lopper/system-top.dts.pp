# 0 "/home/yousef/Vivado_workspace/RFIC_SPI/Soft/RFIC_platform/hw/sdt/system-top.dts"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/yousef/Vivado_workspace/RFIC_SPI/Soft/RFIC_platform/hw/sdt/system-top.dts"
/dts-v1/;
# 1 "/home/yousef/Vivado_workspace/RFIC_SPI/Soft/RFIC_platform/hw/sdt/pl.dtsi" 1
/ {
 ...
 amba_pl: amba_pl {
  ...
  SPI_Master_AXI_0: SPI_Master_AXI@44a00000 {
   xlnx,s00-axi-data-width = <32>;
   compatible = "xlnx,SPI-Master-AXI-1.0";
   status = "okay";
   xlnx,s00-axi-addr-width = <5>;
   xlnx,ip-name = "SPI_Master_AXI";
   xlnx,edk-iptype = "PERIPHERAL";
   reg = <0x44a00000 0x10000>;
   xlnx,name = "SPI_Master_AXI_0";
  };
...
# 3 "/home/yousef/Vivado_workspace/RFIC_SPI/Soft/RFIC_platform/hw/sdt/system-top.dts" 2
/ {
 board = "cmod_a7-15t";
 compatible = "xlnx,cmod_a7-15t";
 device_id = "7a15t";
 #address-cells = <1>;
 #size-cells = <1>;
 family = "microblaze";
 ...
 cpus_microblaze_0: cpus_microblaze@0 {
  address-map = <0x00000000 &microblaze_0_local_memory_dlmb_bram_if_cntlr_memory 0x00000000 0x10000>,
         ...
         <0x44a00000 &SPI_Master_AXI_0 0x44a00000 0x10000>;
